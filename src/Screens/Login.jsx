      ...
      <div className='login-boxLogin'>
        ...
        <form onSubmit={handleSummit}>
          <div className='user-boxLogin'>
            <input required='' className="email" name='email' type='text' onChange={handleOnchange} />
          ...
          <div className='user-boxLogin'>
            ...
            <div className='password-container'>
              ...
              />
              {user.showPassword ? (
                <VisibilityIcon onClick={toggleShowPassword} className='visibility'></VisibilityIcon>
              ) : (
                <VisibilityOffIcon  onClick={toggleShowPassword} className='visibility'></VisibilityOffIcon>
              )}
            </div>
        ...
        <p>
          Don't have an account? <NavLink className='a2' to='/ChooseRegister'>Sign up!</NavLink>{' '}
        </p>
      </div>
    </div>
  );
